...
GetByteArrayElements _ZN3art3JNI20GetByteArrayElementsEP7_JNIEnvP11_jbyteArrayPh
*/  
...
function hook_libart() {
    ...
    for (var i = 0; i < symbols.length; i++) {
        ...
        if (symbol.name.indexOf("art") >= 0 &&
            ...
            else if (symbol.name.indexOf("GetByteArray") >= 0) {
                addrRegisterNatives = symbol.address;
                console.log("GetByteArray is at ", symbol.address, symbol.name);
            }
        }
    }
